...
class grade_letter_updated extends base {
    ...
    public function get_url() {
        if ($this->other['courseid'] > 0) {
            return new \moodle_url('/grade/edit/grade_letter/index.php', array('id' => $this->courseid));
        } else {
            return new \moodle_url('/grade/edit/grade_letter/index.php', array());
        }
    }
    ...
    public static function get_objectid_mapping() {
        return array('db' => 'grade_letter', 'restore' => 'grade_letter');
    }
