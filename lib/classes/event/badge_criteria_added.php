...
/**
 * Event triggered after criteria is added to a badge.
 *
 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class badge_criteria_added extends base {
    ...
    public static function get_name() {
        return get_string('eventbadgecriteriaadded', 'badges');
    }
    ...
    public function get_description() {
        return "The user with id '$this->userid' has added criteria to the badge with id '".$this->other['badgeid']."'.";
    }
