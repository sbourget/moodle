...
class core_blog_events_testcase extends advanced_testcase {
    ...
    public function test_external_blog_added_event() {
        ...
        $event = \core\event\blog_external_blog_added::create($eventparams);
        ...
        $this->assertInstanceOf('\core\event\blog_external_blog_added', $event);
    ...
    public function test_external_blog_updated_event() {
        ...
        $event = \core\event\blog_external_blog_updated::create($eventparams);
        // Trigger and capture the event.
        $sink = $this->redirectEvents();
        $event->trigger();
        $events = $sink->get_events();
        ...
        // Check that the event data is valid.
        $this->assertInstanceOf('\core\event\blog_external_blog_updated', $event);
        $this->assertEquals(1001, $event->objectid);
        $this->assertEquals('http://moodle.org', $event->other['url']);
        $this->assertDebuggingNotCalled();
    }
    ...
    public function test_external_blog_removed_event() {
        ...
        $event = \core\event\blog_external_blog_removed::create($eventparams);
        // Trigger and capture the event.
        $sink = $this->redirectEvents();
        $event->trigger();
        $events = $sink->get_events();
        ...
        // Check that the event data is valid.
        $this->assertInstanceOf('\core\event\blog_external_blog_removed', $event);
        $this->assertEquals(1001, $event->objectid);
        $this->assertDebuggingNotCalled();
    }
    ...
    public function test_external_blogs_viewed_event() {
        ...
        $event = \core\event\blog_external_blogs_viewed::create($eventparams);
        // Trigger and capture the event.
        $sink = $this->redirectEvents();
        $event->trigger();
        $events = $sink->get_events();
        ...
        // Check that the event data is valid.
        $this->assertInstanceOf('\core\event\blog_external_blogs_viewed', $event);
        $this->assertDebuggingNotCalled();
    }
}
