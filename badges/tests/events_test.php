...
class core_badges_events_testcase extends core_badges_badgeslib_testcase {
    ...
    public function test_badge_criteria_added() {
        ...
        $this->assertEquals($criteria_profile->id, $event->objectid);
        $this->assertEquals($criteria_profile->badgeid, $event->other['badgeid']);
        $this->assertDebuggingNotCalled();
        $sink->close();
    ...
    public function test_badge_criteria_updated() {
        ...
        $criteria_overall->save(array('agg' => BADGE_CRITERIA_AGGREGATION_ALL));
        $criteria_profile = award_criteria::build(array('criteriatype' => BADGE_CRITERIA_TYPE_PROFILE, 'badgeid' => $this->badgeid));
        $params = array('agg' => BADGE_CRITERIA_AGGREGATION_ALL, 'field_address' => 'address');
        $criteria_profile->save($params);
        $badge = new badge($this->badgeid);
    ...
    public function test_badge_criteria_deleted() {
        ...
        $this->assertEquals($criteria_overall->badgeid, $event->other['badgeid']);
        $this->assertDebuggingNotCalled();
        $sink->close();
