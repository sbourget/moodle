...
$string['criteria_descr_short7'] = 'Cohort membership in <strong>{$a}</strong> of: ';
...
$string['criteria_descr_single_7'] = 'Membership in the following cohort is required:';
...
$string['criteria_descr_7'] = 'Membership in <strong>{$a}</strong> of the following cohorts is required:';
...
$string['criteria_7'] = 'Cohort membership';
$string['criteria_7_help'] = 'Allows a badge to be awarded to users for becoming a member of certian cohorts.';
