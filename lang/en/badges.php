...
$string['criteria_descr_single_8'] = 'The following badge has to be earned:';
...
$string['criteria_descr_8'] = '<strong>{$a}</strong> of the following badges have to be earned:';
...
$string['criteria_8'] = 'Awarded badges';
$string['criteria_8_help'] = 'Allows a badge to be awarded to users based on the other badges thay have earned.';
