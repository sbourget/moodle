...
if ($ADMIN->fulltree) {
    ...
    $settings->add(new admin_setting_heading('auth_email/pluginname', '', new lang_string('auth_emaildescription', 'auth_email')));
    ...
    $settings->add(new admin_setting_configselect('auth_email/recaptcha',
        new lang_string('auth_emailrecaptcha_key', 'auth_email'), new lang_string('auth_emailrecaptcha', 'auth_email'), 0, $options));
