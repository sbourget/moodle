...
$string['choice:viewpublishedresults'] = 'View published results';
...
$string['publishafteranswer'] = 'Show results to users after they answer';
$string['publishafterclose'] = 'Show results to users only after the choice is closed';
$string['publishalways'] = 'Always show results to users';
$string['publishanonymous'] = 'Publish anonymous results, do not show users names';
$string['publishnames'] = 'Publish full results, showing names and their choices';
$string['publishnot'] = 'Do not publish results to users';
